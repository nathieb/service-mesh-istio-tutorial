...
* Les **différents services** sont généralement l’œuvre d’équipes métiers différentes qui peuvent donc plus facilement développer de manière **autonome** leur fonctionnalité, on parle de couplage faible.
